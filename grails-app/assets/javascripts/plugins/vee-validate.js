...
var messages = {
  ...
  alpha_dash: function (field) { return ("El campo " + field + " puede contener caracteres alfanuméricos, así como guiones y guiones bajos "); },
  alpha_num: function (field) { return ("El campo" + field + " solo puede contener caracteres alfanuméricos."); },
  alpha_spaces: function (field) { return ("El campo " + field + " solo puede contener caracteres alfabéticos y espacios."); },
  alpha: function (field) { return ("El campo " + field + " solo puede contener caracteres alfabéticos."); },
  before: function (field, ref) {
    var target = ref[0];
    var inclusion = ref[1];

    return ("el Campo " + field + " debe estar antes " + (inclusion ? 'o igual a ' : '') + target + ".");
},
  ...
  confirmed: function (field) { return ("El campo " + field + " de confirmacion no coincide"); },
  credit_card: function (field) { return ("el campo " + field + " es invalido"); },
  ...
  date_format: function (field, ref) {
    ...
    return ("El campo " + field + " debe ser en el formato " + format + ".");
},
  decimal: function (field, ref) {
    if ( ref === void 0 ) ref = [];
    var decimals = ref[0]; if ( decimals === void 0 ) decimals = '*';

    return ("El campo " + field + " debe ser numérico y contener " + (!decimals || decimals === '*' ? '' : decimals) + " puntos decimales.");
},
  digits: function (field, ref) {
    var length = ref[0];

    return ("El campo " + field + " debe ser numérico y contener exactamente " + length + " digitos.");
},
  dimensions: function (field, ref) {
    var width = ref[0];
    var height = ref[1];

    return ("El campo " + field + " debe teber " + width + " pixeles por " + height + " pixeles.");
},
  email: function (field) { return ("El campo " + field + " debe ser un email valido."); },
  ext: function (field) { return ("El campo " + field + " debe ser un archivo valido."); },
  image: function (field) { return ("El campo " + field + " debe ser una imagen."); },
  in: function (field) { return ("El campo " + field + " debe contener un valor correcto."); },
  integer: function (field) { return ("El campo " + field + " debe ser entero."); },
  ip: function (field) { return ("El campo " + field + " debe ser una dirección ip valida"); },
  length: function (field, ref) {
    var length = ref[0];
    var max = ref[1];

    if (max) {
      return ("El campo" + field + " debe ser entre " + length + " y " + max + ".");
    }

    return ("El campo " + field + " debe tener un tamaño" + length + ".");
  },
  max: function (field, ref) {
    var length = ref[0];

    return ("El campo " + field + " no puede ser mayor que " + length + " caracteres.");
},
  max_value: function (field, ref) {
    var max = ref[0];

    return ("El campo " + field + " debe ser" + max + " o menor.");
},
  mimes: function (field) { return ("El campo " + field + " debe ser un fichero de tipo valido."); },
  min: function (field, ref) {
    var length = ref[0];

    return ("El campo " + field + " el campo debe ser al menos " + length + " caracteres.");
},
  min_value: function (field, ref) {
    var min = ref[0];

    return ("El campo " + field + " debe ser" + min + " o mayor.");
},
    not_in: function (field) { return ("El campo " + field + " debe ser un valor válido."); },
  numeric: function (field) { return ("El campo " + field + "  solo puede contener caracteres numéricos."); },
  regex: function (field) { return ("El formato del campo " + field + " no es válido."); },
  required: function (field) { return ("El campo " + field + " es requerido."); },
  size: function (field, ref) {
    var size = ref[0];

    return ("El tamaño del campo " + field + " debe ser menor a " + (formatFileSize(size)) + ".");
},
